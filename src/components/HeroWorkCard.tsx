...
export default function HeroWorkCard() {
  return (
    <div className="group relative w-full max-w-5xl md:min-h-96 border border-b-0 bg-black border-gray-700 rounded-3xl overflow-hidden  text-white mx-auto hover:shadow-lg transition-shadow duration-300 ease-in-out flex flex-col md:justify-between items-center py-8">
